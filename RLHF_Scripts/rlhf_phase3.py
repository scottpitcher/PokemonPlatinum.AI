...
from RLHF_Scripts.modular_scripts.load_model import load_phase_3
...
from RLHF_Scripts.modular_scripts.rlhf_utils import open_emulator, perform_action, capture_state, phase3_reward
ACTION_MAPPING = {
    "a": 0,
    "b": 1,
    "x": 2,
...
for episode in range(num_episodes):   # Looping over num_episodes
    ...
    while not done:
        ...
        # Getting reward
        reward, done = phase3_reward(screenshot=next_state)
